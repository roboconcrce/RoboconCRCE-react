          ...
          <Row>
            <Col lg={16} xs={24}>
              <div className="ac-list-content">
                <h1>ROBOCON 2020</h1>
                <p>
                  Theme: ROBO RUGBY 7s : Play rugby 7's game using two robots
                </p>
                <ul>
                  <li>
                    Secured <strong>AIR-11</strong> in Stage 1 of the
                    competition.
                  </li>
                  <li>Successfully implemented Try Robot and Pass Robot.</li>
                  <li>
                    Successfully done passing and receiving of rugby ball by the
                    bots.
                  </li>

                  <li>
                    Achieved a kicking range of <strong>15 m </strong>with Try
                    robot.
                  </li>
                </ul>
              </div>
          ...
          <Row>
            ...
            <Col lg={16} xs={24}>
              <div className="ac-list-content">
                <h1>ROBOCON 2018</h1>
                <p>
                  Theme: NÉM CÒN : The Festival Wishing Happiness and Prosperity
                ...
                <ul>
                  ...
                  <li>Ranked 3rd among Mumbai University Colleges.</li>
                  <li>
                    We successfully simulated the throwing and landing of
                    shuttlecocks using MATLAB.
                  </li>
                  <li>
        ...
        <div className="ac-list-item">
          <Row>
            <Col lg={16} xs={24}>
              <div className="ac-list-content">
                <h1>ROBOCON 2017</h1>
                <p>Theme: Asobi : The Landing Disc</p>
                <ul>
                  <li>
                    Ranked 18th among 112 national participating colleges.
                  </li>
                  <li>Ranked 2nd among Mumbai University Colleges</li>
                  <li>
                    The robot was able to land disk in all the seven spots of
                    varying height and distance as given in problem statement.
                  </li>
                </ul>
              </div>
            </Col>
          ...
          <Row>
            ...
            <Col lg={16} xs={24}>
              <div className="ac-list-content">
                <div>
                  <h1>ROBOCON 2016</h1>
                  <p>Theme: Chai-Yo : Clean Energy Recharging the World</p>
                  <ul>
                    <li>
                      Ranked 21st among 105 national participating colleges
                    </li>
                    <li>Ranked 1st in Mumbai Colleges</li>
                    <li>
                      One of the teams with successful completion of river
                      crossing as mentioned in problem statement.
                    </li>
                  </ul>
                </div>
              </div>
